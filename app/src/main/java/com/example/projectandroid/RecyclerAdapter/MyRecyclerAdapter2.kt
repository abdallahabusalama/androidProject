...
class MyRecyclerAdapter2(val context: Context, val list: ArrayList<MyModel>) : RecyclerView.Adapter<MyRecyclerAdapter2.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemcat.setOnClickListener {
            var intent = Intent(context, detailscategory::class.java)
